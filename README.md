# MEDI-524-YTE-Model
Whole-body PBPK model of the antibody MEDI-524-YTE  (variant of MEDI-524 with a YTE mutation to increase affinity to FcRn) in monkeys [1].
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/MEDI524YTE-Model/releases/latest).**
